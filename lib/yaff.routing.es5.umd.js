  ...
  function () {
    ...
    _createClass(Router, [{
      ...
      value: function _ensureRouteHanlder(path, router) {
        ...
        if (!routeHandler) {
          routeHandler = new config.RouteHandler(path, router instanceof config.Router ? router : null);
          ...
          return regeneratorRuntime.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                ...
                case 18:
                  this.handleError(res.error, req, res); // if (res.error) {
      ...
      value: function setErrorHandlers(shouldReplace) {
        ...
        if (_typeof(shouldReplace) == 'object') {
          var _handlers2;

          var _handlers = handlers;
          handlers = Array.isArray(shouldReplace) ? shouldReplace : [shouldReplace];

          (_handlers2 = handlers).push.apply(_handlers2, _toConsumableArray(_handlers));
        ...
        this._errorHandlers = Object.assign.apply(Object, [{}].concat(_toConsumableArray(handlers)));
      } //#endregion
      ...
      value: function navigate(url) {
        ...
        var shouldTrigger = options.trigger !== false && !iscurrent || options.trigger === true; //console.log(' -router- ', shouldTrigger, this);
      ...
      value: function browserPushState(url, options) {
        url = this._getUrl(url);
        var state = this.getCurrentState(options); //console.log(' -pushstate- ', state);
  ...
  function () {
    ...
    _createClass(RouteHandler, [{
      ...
      value: function extractRouteArguments(req, _path) {
        ...
        var params = (pattern.exec(req.path) || []).slice(1); //console.log('>>', params, pattern);
        ...
        var args = matches.reduce(function (memo, paramName, index) {
          ...
          if (index > params.length) return memo; //console.log('-args-', paramName, index, params[index], params);

          addValue(memo, paramName, params[index]); //console.log(' ', Object.assign({}, memo));

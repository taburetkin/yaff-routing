(function (global, factory) {
	...
	*/
	...
	function comparator() {
	  ...
	  for (var _len2 = arguments.length, cmps = new Array(_len2), _key2 = 0; _key2 < _len2; _key2++) {
	    cmps[_key2] = arguments[_key2];
	  }
	...
	function () {
	  ...
	  _createClass(Router, [{
	          ...
	          while (1) {
	            switch (_context.prev = _context.next) {
	              case 0:
	                ...
	                context = this.findRequestRouteHandlerContext(req);
	    ...
	    key: "findRequestRouteHandlerContext",
	    value: function findRequestRouteHandlerContext(req) {
	      var _this2 = this;
	...
	function () {
	  ...
	  _createClass(PathSegment, [{
	    ...
	    value: function getPatternValue() {
	      ...
	      var value = this.value.replace(/:\w+/g, '\\w+');

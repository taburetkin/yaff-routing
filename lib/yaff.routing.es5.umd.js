  ...
  */
  ...
  var index$1 = {
    ...
    use: function use() {
      ...
      return (_this$_ensureRouter2 = this._ensureRouter()).use.apply(_this$_ensureRouter2, arguments);
    },
    ...
    start: function start() {
      var _this$_ensureRouter3;

      return (_this$_ensureRouter3 = this._ensureRouter()).start.apply(_this$_ensureRouter3, arguments);
    },
    ...
    navigate: function navigate() {
      ...
      return (_this$instance3 = this.instance).navigate.apply(_this$instance3, arguments);
    },

(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('core-js/modules/es.symbol'), require('core-js/modules/es.symbol.description'), require('core-js/modules/es.symbol.iterator'), require('core-js/modules/es.array.concat'), require('core-js/modules/es.array.iterator'), require('core-js/modules/es.array.splice'), require('core-js/modules/es.object.assign'), require('core-js/modules/es.object.to-string'), require('core-js/modules/es.promise'), require('core-js/modules/es.regexp.to-string'), require('core-js/modules/es.string.iterator'), require('core-js/modules/web.dom-collections.iterator'), require('regenerator-runtime/runtime'), require('core-js/modules/es.string.search'), require('core-js/modules/es.string.starts-with'), require('core-js/modules/web.url'), require('core-js/modules/es.array.slice'), require('core-js/modules/es.regexp.constructor'), require('core-js/modules/es.string.match'), require('core-js/modules/es.string.replace')) :
  typeof define === 'function' && define.amd ? define(['core-js/modules/es.symbol', 'core-js/modules/es.symbol.description', 'core-js/modules/es.symbol.iterator', 'core-js/modules/es.array.concat', 'core-js/modules/es.array.iterator', 'core-js/modules/es.array.splice', 'core-js/modules/es.object.assign', 'core-js/modules/es.object.to-string', 'core-js/modules/es.promise', 'core-js/modules/es.regexp.to-string', 'core-js/modules/es.string.iterator', 'core-js/modules/web.dom-collections.iterator', 'regenerator-runtime/runtime', 'core-js/modules/es.string.search', 'core-js/modules/es.string.starts-with', 'core-js/modules/web.url', 'core-js/modules/es.array.slice', 'core-js/modules/es.regexp.constructor', 'core-js/modules/es.string.match', 'core-js/modules/es.string.replace'], factory) :
  ...
  function () {
    ...
    _createClass(Routing, [{
      ...
      key: "_setOnPopstate",
      value: function _setOnPopstate() {
        var _this = this;

        this._onPopstate = function (event) {
          var options = event.state.navigateOptions || {
            trigger: true
          };
          options.pushState = false;
          return _this.navigate(options);
        };
      ...
      key: "_removeOnPopstate",
      value: function _removeOnPopstate() {
  ...
  function () {
    ...
    _createClass(RouteHandler, [{
      ...
      value: function extractRouteArguments(req) {
        ...
        params.pop();
        var matches = this.path.match(/:\w+/g) || [];

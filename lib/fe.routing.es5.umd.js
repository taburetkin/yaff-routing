(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('@babel/runtime/regenerator'), require('@babel/runtime/helpers/toConsumableArray'), require('@babel/runtime/helpers/asyncToGenerator'), require('@babel/runtime/helpers/typeof'), require('@babel/runtime/helpers/defineProperty'), require('@babel/runtime/helpers/classCallCheck'), require('@babel/runtime/helpers/createClass')) :
	typeof define === 'function' && define.amd ? define(['@babel/runtime/regenerator', '@babel/runtime/helpers/toConsumableArray', '@babel/runtime/helpers/asyncToGenerator', '@babel/runtime/helpers/typeof', '@babel/runtime/helpers/defineProperty', '@babel/runtime/helpers/classCallCheck', '@babel/runtime/helpers/createClass'], factory) :
	(global = global || self, global.routing = factory(global._regeneratorRuntime, global._toConsumableArray, global._asyncToGenerator, global._typeof, global._defineProperty, global._classCallCheck, global._createClass));
}(this, function (_regeneratorRuntime, _toConsumableArray, _asyncToGenerator, _typeof, _defineProperty, _classCallCheck, _createClass) { 'use strict';

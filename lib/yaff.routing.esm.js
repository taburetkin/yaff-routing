 ...
 * @returns {string}
 */
function normalizeUrl(urlText = '', args) {
...
export { RequestContext, ResponseContext, RouteHandler, Router, RoutesManager, config, normalizeUrl, replaceUrlParams, routing };
